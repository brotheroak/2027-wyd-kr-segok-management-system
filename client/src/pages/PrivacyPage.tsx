      ...
      <article className="panel policy-panel">
        ...
        <PolicySection title="2. 수집하는 개인정보">
          <ul>
            ...
            <li>순례자 운영 정보: 순례자 ID, 성명, 세례명, 성별, 교구, 지역, 학년, 나이, 배정 호스트, 식단, 알레르기, 발열·건강 특이사항, 식사 제공 기록</li>
        ...
        <PolicySection title="8. 안전성 확보 조치">
          <p>본 시스템은 운영자 권한을 일반 운영자와 개인정보 관리자로 분리합니다. 일반 운영자에게는 이름, 연락처, 이메일, 주소 등 주요 개인정보가 익명화되어 표시되며, 원본 개인정보와 식단·알레르기·발열 등 건강 관련 민감정보는 개인정보 관리자만 열람할 수 있습니다. 순례자 바코드는 행사 운영을 위한 내부 식별값이며 주민등록번호 등 국가 식별정보를 포함하지 않습니다.</p>
        </PolicySection>
