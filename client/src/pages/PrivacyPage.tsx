    ...
    <main className="single policy-page">
      ...
      <article className="panel policy-panel">
        ...
        <PolicySection title="3. 이용 목적과 법적 근거">
          <p>개인정보는 홈스테이 신청 확인, 신청서 수정 및 취소, 운영자 검토, 순례자 요청 조건과의 매칭, 순례자 카드 발급·발송, 배정 호스트의 식단 확인, 행사 출석 확인과 안전한 인원·동선 관리, 문의 응대, 시스템 보안과 품질 개선을 위해 이용됩니다. 호스트 로그인은 성명, 연락처, 4자리 비밀번호로 진행하고 순례자 카드는 개인별 만료 접속 코드로 엽니다. 비밀번호 원문은 저장하지 않으며 접속 코드는 암호화 값과 조회용 해시로 관리합니다.</p>
        </PolicySection>
