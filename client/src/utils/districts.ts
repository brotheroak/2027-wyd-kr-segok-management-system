...
export const districtGuideSections: DistrictGuideSection[] = [
  ...
  },
  {
    no: "8",
    name: "8구역",
    areas: ["자곡동 교수·쟁골·못골", "강남아이파크", "LH 행복주택", "오피스텔"],
    bans: [
      { ban: "8-1", description: "교수마을 밤고개로12길~14길, 자곡로7길 일대, 강남푸르지오시티2차, 더시그넘하우스" },
      { ban: "8-2", description: "강남아이파크 7단지 701-710동, 강남 LH 8단지/자곡로154 오피스텔" },
      { ban: "8-3", description: "LH 행복주택 1단지, 디아크리온 강남" },
  ...
  },
  {
    ...
    bans: [
      ...
      { ban: "9-2", description: "율현동 방죽1마을 밤고개로24길 20~66-18" },
      { ban: "9-3", description: "율현동 방죽1마을 밤고개로24길 75~87" },
      { ban: "9-4", description: "밤고개로26길로 시작하는 주택(한신휴플러스 제외)" }
    ]
  },
  {
    no: "10",
  ...
  },
  {
    ...
    areas: ["자곡동 래미안포레"],
    bans: [
      { ban: "11-1", description: "래미안포레 301-304동" },
      { ban: "11-2", description: "래미안포레 305-308동" },
      { ban: "11-3", description: "래미안포레 309-315동" }
    ]
  },
  {
    no: "12",
    ...
    bans: [
      { ban: "12-1", description: "한양수자인 401-407동" },
      { ban: "12-2", description: "한양수자인 408-413동" },
      { ban: "12-3", description: "한양수자인 414-419동" },
      { ban: "12-4", description: "한양수자인 420-426동, 율현리엔파크" }
    ]
  },
  {
    no: "99",
