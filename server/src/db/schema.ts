...
export const sqliteApplications = sqliteTable("homestay_applications", {
  ...
  districtNo: sqliteText("district_no").notNull().default("13"),
  districtName: sqliteText("district_name").notNull().default("구역외"),
  districtBan: sqliteText("district_ban").notNull().default("13-1"),
  districtLabel: sqliteText("district_label").notNull().default("구역외 (13구역)"),
...
export const pgApplications = pgTable("homestay_applications", {
  ...
  districtNo: pgText("district_no").notNull().default("13"),
  districtName: pgText("district_name").notNull().default("구역외"),
  districtBan: pgText("district_ban").notNull().default("13-1"),
  districtLabel: pgText("district_label").notNull().default("구역외 (13구역)"),
