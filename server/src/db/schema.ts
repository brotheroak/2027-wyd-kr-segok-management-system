...
export const sqlitePilgrims = sqliteTable("pilgrims", {
  ...
  preferredLanguage: sqliteText("preferred_language").notNull().default("en"),
  accessToken: sqliteText("access_token"),
  accessTokenHash: sqliteText("access_token_hash").unique(),
  accessTokenExpiresAt: sqliteText("access_token_expires_at"),
  gender: sqliteText("gender").notNull(),
...
export const pgPilgrims = pgTable("pilgrims", {
  ...
  email: pgText("email").notNull().default(""), preferredLanguage: pgText("preferred_language").notNull().default("en"),
  accessToken: pgText("access_token"), accessTokenHash: pgText("access_token_hash").unique(), accessTokenExpiresAt: pgText("access_token_expires_at"),
